...
2. If the total number of messages is greater than or equal to 50, then the application will stop after processing 50 messages and printing adjustments made.
